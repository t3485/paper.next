...
namespace Paper.Migrations
{
    ...
    partial class PaperMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paper.Papers.MarketPaper", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.OwnsOne("Paper.Papers.Price.PaperPrice", "Price", b1 =>
                        {
                            ...
                            b1.Property<decimal>("Turn")
                                .HasColumnName("Turn")
                                .HasColumnType("decimal(18,2)");

                            b1.HasKey("PaperDayPricePointId");

                            b1.ToTable("AppPaperDayPricePoint");

                            b1.WithOwner()
                                .HasForeignKey("PaperDayPricePointId");
                        });
                });
                    ...
                    b.OwnsOne("Paper.Papers.Price.PaperPrice", "Price", b1 =>
                        {
                            ...
                            b1.HasKey("PaperWeekPricePointId");

                            b1.ToTable("AppPaperWeekPricePoint");

                            b1.WithOwner()
                                .HasForeignKey("PaperWeekPricePointId");
                        });
                });
